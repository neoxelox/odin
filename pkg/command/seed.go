...
INSERT INTO "post_history" ("id", "post_id", "message", "categories", "state", "media", "widgets", "created_at")
VALUES ('9bsv0s4ilem002n1mt40', '9bsv0s2u84o002rhqpa0', '¿A alguien le sobran huevos? No me acordaba de que hoy era festivo.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '13 days' - interval '2 hours'),
       ('9bsv0s4ilem002n1mt4g', '9bsv0s6k1b9g02sp84c0', 'Puedes pasarte por mi piso si quieres y te doy un par.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '13 days' - interval '1 hour'),
       ('9bsv0s4ilem002n1mt50', '9bsv0s2r0u8g02qj5ai0', 'A mí me ha pasado lo mismo 😂🤣', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '13 days'),
       ('9bsv0s4ilem002n1mt5g', '9bsv0s2tchag02t6gg10', 'Me acabo de quedar sin coche. Alguien sabe qué bus tengo que coger para ir hasta la estación de trenes?', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '11 days' - interval '5 hour'),
       ('9bsv0s4ilem002n1mt60', '9bsv0s09onsg02s5c8ag', 'Sí, puedes coger la línea 7 que está cruzando la calle, frente al supermercado. El bus pasa cada 5 minutos más o menos así que no deberías tener ningún problema.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '11 days' - interval '3 hour'),
       ('9bsv0s4ilem002n1mt6g', '9bsv0s2ccr9g02gl6r50', 'Yo siempre cojo la línea 7.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '11 days' - interval '4 hour' - interval '32 minutes'),
       ('9bsv0s4ilem002n1mt70', '9bsv0s4ilem002n1msv0', 'Buenos días. ¿A alguien más no le funciona la tele? No sintoniza ningún canal. Creo que la antena de la terraza se rompió con la tormenta ayer...', '{}', 'PENDING', '{}', '{"Poll": null}', current_timestamp - interval '9 day' + interval '3 hours'),
       ('9bsv0s4ilem002n1mt7g', '9bsv0s4ilem002n1msvg', 'Sí, no funciona', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '9 days' + interval '5 hour' - interval '47 minutes'),
       ('9bsv0s4ilem002n1mt80', '9bsv0s4ilem002n1mt00', 'Mañana de 4 a 7 de la tarde celebraremos el cumpleaños de mi hijo en mi piso. Espero que no os importe que pongamos música durante la pequeña fiesta.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '8 days' - interval '7 hour' - interval '02 minutes'),
       ('9bsv0s4ilem002n1mt8g', '9bsv0s4ilem002n1mt0g', 'He hecho asado argentino y me ha sobrado muchísimo, si alguien quiere que me lo diga!', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '8 days' - interval '1 hour' - interval '05 minutes'),
       ('9bsv0s4ilem002n1mt90', '9bsv0s4ilem002n1mt10', 'El ascensor parece que no funciona. Cuando lo llamo no sube.', '{}', 'PENDING', '{}', '{"Poll": null}', current_timestamp - interval '6 day' - interval '2 hours' - interval '56 minutes'),
       ('9bsv0s4ilem002n1mt9g', '9bsv0s4ilem002n1mt1g', 'Es verdad, no va muy bien', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '6 days' - interval '1 hour' - interval '13 minutes'),
       ('9bsv0s4ilem002n1mta0', '9bsv0s4ilem002n1mt20', 'Anoche se escapó nuestro perro. Es un labrador blanco, todavía tiene 8 meses. Si lo véis por el barrio por favor avisadme a mí o a mi mujer. Muchísimas gracias.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '2 days' - interval '7 hour' - interval '41 minutes'),
       ('9bsv0s4ilem002n1mtag', '9bsv0s4ilem002n1mt2g', 'No te preocupes Daniel, seguro que aparece.', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '6 days' + interval '1 hour' - interval '13 minutes'),
       ('9bsv0s4ilem002n1mtb0', '9bsv0s4ilem002n1mt30', 'Muchas gracias', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '6 days' + interval '1 hour' - interval '26 minutes'),
       ('9bsv0s4ilem002n1mtbg', '9bsv0s4ilem002n1mt3g', 'Nosotros no hemos visto nada. Si le vemos te avisamos', '{}', null, '{}', '{"Poll": null}', current_timestamp - interval '6 days' + interval '5 hour' - interval '49 minutes')
;
`
