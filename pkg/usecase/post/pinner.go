...
func NewPinnerUsecase(configuration internal.Configuration, logger core.Logger, postRepository repository.PostRepository,
	membershipRepository repository.MembershipRepository, communityRepository repository.CommunityRepository) *PinnerUsecase {
	return &PinnerUsecase{
...
func (self *PinnerUsecase) Pin(ctx context.Context, pinner model.User, communityID string, postID string) (*model.Community, error) {
