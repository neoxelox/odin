...
func NewVoterUsecase(configuration internal.Configuration, logger core.Logger, postRepository repository.PostRepository,
	membershipRepository repository.MembershipRepository) *VoterUsecase {
	return &VoterUsecase{
...
func (self *VoterUsecase) Vote(ctx context.Context, voter model.User, communityID string, postID string) (*model.Post, *model.PostHistory, error) {
